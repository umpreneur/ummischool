...
"quran-en-thuisonderwijs": {
 ...
 "<strong>Luisteren als basis</strong><br/>Kies steeds één specifieke ayah of één surah en blijf daarbij. Zet diezelfde recitatie zo vaak mogelijk aan, bij voorkeur van één vaste recitator, zodat de klank herkenbaar wordt.<br>Een recitator die hier bijzonder geschikt voor is, is Mahmoud Khalil Al-Husary. Zijn recitatie is rustig, helder.<br> Laat juist die ayah of surah meeklinken op momenten die er toch al zijn: tijdens het spelen, in de auto, bij het opruimen of tijdens rustige momenten.<br/><br/>Het kind hoeft nog niets te zeggen of te doen. Luisteren alleen is al leren. Wat vaak wordt gehoord, blijft vanzelf hangen.",
