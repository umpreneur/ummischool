...
"quran-en-thuisonderwijs": {
  ...
  content: [
    "Wie een jong kind observeert, ziet hoe leren vanzelf gaat. Een anasheed dat vaak wordt gehoord, blijft hangen. Een zinnetje dat steeds terugkomt, wordt moeiteloos herhaald. Zonder uitleg, zonder druk. Voor jonge kinderen voelt herhaling niet als oefenen, maar als spel. <br> Voor hen is leren niet doelbewust of inspannend zoals bij volwassenen. Het brein is sterk gericht op ontdekken en patroonherkenning. Daarom ervaren zij dit subjectief als spel, ook al vindt er objectief leren plaats.",
 ...
 "<strong>Het begin</strong><br/>Begin met Surah al-Fātiḥah. Deze surah komt dagelijks terug in het gebed en wordt daardoor automatisch vaak herhaald. Dat maakt haar een logische eerste stap. Daarna kun je verdergaan met de korte suwar uit Juz’ ‘Amma. De ayahs zijn kort, overzichtelijk en goed te volgen voor jonge kinderen.",
 "<strong>Luisteren als basis</strong><br/> Kies steeds één specifieke ayah of één surah en blijf daarbij. Zet diezelfde recitatie zo vaak mogelijk aan, bij voorkeur van één vaste recitator, zodat de klank herkenbaar wordt. Laat juist die ayah of surah meeklinken op momenten die er toch al zijn: tijdens het spelen, in de auto, bij het opruimen of tijdens rustige momenten. Een recitator die hier bijzonder geschikt voor is, is Mahmoud Khalil Al-Husary. Zijn recitatie is rustig, helder en gelijkmatig, waardoor ayahs goed te volgen en gemakkelijk te herkennen zijn, vooral voor jonge kinderen. Het kind hoeft nog niets te zeggen of te doen. Luisteren alleen is al leren. Wat vaak wordt gehoord, blijft vanzelf hangen.",
