...
"quran-en-thuisonderwijs": {
  ...
  content: [
    "Wie een jong kind observeert, ziet hoe leren vanzelf gaat. Een anasheed dat vaak wordt gehoord, blijft hangen. Een zinnetje dat steeds terugkomt, wordt moeiteloos herhaald. Zonder uitleg, zonder druk. Voor jonge kinderen voelt deze herhaling niet als leren, maar als spel. <br><br> Voor hen is leren niet doelbewust of inspannend zoals bij volwassenen.",
 ...
 "<strong>Het begin</strong><br/>Begin met Surah al-Fātiḥah. Deze surah komt dagelijks terug in het gebed en wordt daardoor automatisch vaak herhaald. Dat maakt haar een logische eerste stap. Daarna kun je verdergaan met de korte suwar uit Juz’ ‘Amma. De ayahs zijn kort, overzichtelijk en goed te volgen voor jonge kinderen.",
    ...
    "<strong>Luisteren als basis</strong><br/> Kies steeds één specifieke ayah of één surah en blijf daarbij. Zet diezelfde recitatie zo vaak mogelijk aan, bij voorkeur van één vaste recitator, zodat de klank herkenbaar wordt. Zet de ayah of surah aan als onderdeel van het dagelijks leven: tijdens het spelen, in de auto, bij het opruimen en op rustige momenten. Laat het kind ondertussen vrij om zijn eigen spel en bezigheden te volgen. Luisteren alleen is al leren.",
{ 
      type: "highlight",
